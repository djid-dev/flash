      ...
      <div className="flex flex-col mt-10 p-4 sm:p-0 justify-center items-center">
        ...
        >
          <p className="text-pretty max-w-[75ch] text-sm duration-700 animate-in fade-in-5 slide-in-from-top-2 md:text-base text-neutral-800 dark:text-neutral-300 sm:text-sm ">
            Your links are important. Use Flash to shorten, brand, share and
            manage your links. <br /> It`s fast, secure and easy to use.
          </p>

          <Link
            href={"/dashboard"}
            className={`${nunitoSans.className} antialiased flex items-center group gap-2 w-fit  my-6 p-3 border-2 border-neutral-300 dark:border-neutral-600    rounded-[.5rem]  hover:border-red-500 dark:hover:border-red-500 hover:text-foreground dark:text-white font-bold`}
          >
            <Link2Icon className="rotate-135 group-hover:rotate-105 transition-transform duration-300 ease-in-out group-hover:text-red-500" />
