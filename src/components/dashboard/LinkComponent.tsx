    ...
    <li className="flex w-full flex-col gap-2 border-b border-violet-600 px-3 py-2">
      ...
      <div className="flex w-full flex-col gap-1 sm:flex-row sm:items-center sm:justify-between sm:gap-x-3">
        <ExternalLink
          ...
          target="_blank"
          className="flex-1 w-fit underline-offset-4 truncate text-sm dark:text-gray-400 text-gray-400  hover:underline"
        >
          {linkInfo.originalUrl}
        </ExternalLink>

        <span className="text-sm dark:text-gray-400 text-gray-400 dark:hover:text-gray-400 hover:text-gray-400">
